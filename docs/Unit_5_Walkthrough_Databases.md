...
Note: You also user author.id=user.id instead of author=user
...
31. The post object is the entire object. I can access other details that are 
...
The output is n ot very useful as it stands below...
...
36. exit() the shell and Open Blog -> views.py
...
42. Use the admin GUI to update Posts. To this we need to register POsts with the admin page.
